...
<html>
  ...
  <body>
    ...
    <header class="intro-header" style="background-image: url('clean_blog/img/diary.jpg')">
        <div class="container">
            <div class="row">
    ...
    <div class="row">
		<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
			<div class="post-preview">
			    ...
			    <input type ="button" name="cancel" value="Cancel" onClick="location.href = 'homepage.jsp';"> 
			</div>
		</div>
	</div>
</div>
